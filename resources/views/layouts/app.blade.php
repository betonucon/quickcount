...
<head>
  ...
  <title>Quick Count | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('home')}}" class="logo">
      ...
      <span class="logo-lg"><b>MULIA-</b>01</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{paslon(1)}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{Auth::user()['name']}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{paslon(1)}}" class="img-circle" alt="User Image">

                <p>
                  {{Auth::user()['name']}} - TPS {{pengguna()['tps']}}
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>{{Auth::user()['name']}}</p>
          <a href="#"><i class="fa fa-circle text-success"></i> TPS {{pengguna()['tps']}}</a>
        </div>
      </div>
      <!-- search form -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020-2019 <a href="{{url('home')}}">uconbeton</a>.</strong> All rights
    reserved.
  </footer>
