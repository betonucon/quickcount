            ...
            <div class="box-body">
                ...
                <form method="post"  id="mysimpan_data" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled id="exampleInputPassword1" value="{{cek_user($data['nik'])}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="tps" id="exampleInputPassword1" value="{{$data['tps']}}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Alamat Lengkap</label>
                        <textarea rows="4" class="form-control" name="alamat" id="exampleInputPassword1" placeholder="Alamat lengkap">{{$data['alamat']}}</textarea>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function simpan_data(){
        var form=document.getElementById('mysimpan_data');
            ...
            $.ajax({
                type: 'POST',
                url: "{{url('/pengguna/simpan_ubah/'.$data['id'])}}",
